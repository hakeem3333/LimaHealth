 ...
 */
export const getAllParentStudentRelationships = async (req, res) => {
    try {
 ...
 * @param res The Express response object.
 */
export const getParentStudentRelationshipById = async (req, res) => {
 ...
 * @param res The Express response object.
 */
export const deleteParentStudentRelationship = async (req, res) => {
    const { parentId, studentId } = req.params;
    try {
...
//# sourceMappingURL=parentStudentRelationship.controller.js.map