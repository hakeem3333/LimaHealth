 ...
 */
export const getAllBiometricLogs = async (req: Request, res: Response): Promise<void> => {
  try {
 ...
 * @param res The Express response object.
 */
export const getBiometricLogById = async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
  try {
    const biometricLog: BiometricLog | null = await prisma.biometricLog.findUnique({
      where: { id },
      include: {
        user: true,
      },
 ...
 * @param res The Express response object.
 */
export const createBiometricLog = async (req: Request, res: Response): Promise<void> => {
 ...
 * @param res The Express response object.
 */
export const updateBiometricLog = async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
  const { userId, heartRate, skinTemp, gsr, movement, stressLevelScore } = req.body;
  try {
 ...
 * @param res The Express response object.
 */
export const deleteBiometricLog = async (req: Request, res: Response): Promise<void> => {
  const { id } = req.params;
  try {
